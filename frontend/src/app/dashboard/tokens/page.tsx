...
export default function TokensPage() {
  ...
  return (
    <div className="space-y-6">
      <DashboardHeader 
        title="Energy Tokens" 
        description="Manage and transfer your energy tokens"
        role="owner"
      />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      <p className="text-lg font-medium text-gray-900 bg-blue-50 px-3 py-1 rounded-lg border border-blue-100">
                        {token.amount} Tokens
                      </p>
                    </div>
                    <button
